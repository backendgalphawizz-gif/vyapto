<div class="inline-page-menu my-4">
    <ul class="list-unstyled">
        ...
        <li class="d-none {{ Request::is('admin/business-settings/web-config/db-index') ?'active':'' }}"><a
                href="{{route('admin.business-settings.web-config.db-index')}}">{{\App\CPU\translate('Clean_Database')}}</a>
        </li>
        <li class="d-none {{ Request::is('admin/system-settings/software-update') ?'active':'' }}"><a
                href="{{route('admin.system-settings.software-update')}}">{{\App\CPU\translate('software_update')}}</a>
        </li>
        <li class="d-none {{ Request::is('admin/business-settings/web-config/theme/setup') ?'active':'' }}"><a
