...
class WebsiteSeeder extends Seeder
{
    ...
    private function seedPageSections(): void
    {
        $sections = [
            ...
            ['page' => 'about', 'section_key' => 'hero', 'title' => 'About Vyapto', 'content' => 'Leading the future of logistics support, business services & operational excellence.', 'sort_order' => 1, 'extra' => ['default_image' => 'images/vyapto-warehouse-bg.png']],
